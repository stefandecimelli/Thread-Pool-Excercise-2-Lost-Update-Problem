...
public class GoodTicketReservationSystem implements TicketReservationSystem {

    Map<String, Integer> trainInfo = new HashMap<String, Integer>(); // trainName:ticketCount

    public GoodTicketReservationSystem() {
        trainInfo.put("a", 100);
        trainInfo.put("b", 100);
    }

    public synchronized void reserveTicket(String trainName, int ticketCount) {
